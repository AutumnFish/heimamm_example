    ...
    <el-card class="card-header">
      ...
      >
        <el-form-item label="学科" prop="subjectId">
          <subjectSelect v-model="filterForm.subjectId"></subjectSelect>
        </el-form-item>
        <el-form-item label="阶段" prop="stepId">
          <el-select v-model="filterForm.stepId" placeholder="请选择阶段">
            <el-option
        ...
        <el-form-item label="企业" prop="enterpriseId">
          <enterpriseSelect
            v-model="filterForm.enterpriseId"
          ></enterpriseSelect>
        </el-form-item>
    ...
    <el-card class="card-main">
      <el-table :data="questionTable">
        ...
        <el-table-column label="学科·阶段">
          <template slot-scope="scope">
            {{ scope.row.subject + '·' + scope.row.step }}
          </template>
        </el-table-column>
...
<script>
  ...
  export default {
    ...
    watch: {
      'filterForm.subjectId'(val) {
        stepList({
          subjectId: val
        }).then(res => {
          // console.log(res)
          this.currentStep = res.data
          this.filterForm.stepId = ''
        })
      }
    },
    data() {
